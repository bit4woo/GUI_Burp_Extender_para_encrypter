...
*/
public class CAESOperator_AES_128 {
	/*
	...
	*/
	...
	private static CAESOperator_AES_128 instance=null;
	public CAESOperator_AES_128(){
	
	}
	public static CAESOperator_AES_128 getInstance(){
		if (instance==null)
		instance= new CAESOperator_AES_128();
		return instance;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String enString = CAESOperator_AES_128.getInstance().encrypt(cSrc);
		System.out.println("加密后的字符串:\n" + enString);
		
		// 需要解密的字符串
		enString="uMHIMfrKEytcQ89qacnLk8rgxBCFayD+yBdoxv1usLg=";
		String DeString = CAESOperator_AES_128.getInstance().decrypt(enString);
		...
		while (true) {
			...
			if (x.equals("de")){
				...
				System.out.println(CAESOperator_AES_128.getInstance().encrypt(cSrc));
			}
			else if (x.equals("en")) {
				...
				String key = "(.2=W$j#z]d3Qx^J";
				System.out.println(CAESOperator_AES_128.getInstance().decrypt(enString));
			}
			else{
